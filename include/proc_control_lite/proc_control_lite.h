...
struct B_EnabledSubsystem_proc_con_e_T {
  SL_Bus_std_msgs_Float32 In1;         /* '<S306>/In1' */
};

/* Block signals for system '<S303>/Enabled Subsystem' */
struct B_EnabledSubsystem_proc_con_f_T {
  SL_Bus_sonia_common_ros2_BodyVelocityDVL In1;/* '<S307>/In1' */
};

/* Block signals for system '<S304>/Enabled Subsystem' */
struct B_EnabledSubsystem_proc_con_a_T {
  SL_Bus_sensor_msgs_Imu In1;          /* '<S308>/In1' */
};
...
struct B_proc_control_lite_T {
  ...
  char_T b_zeroDelimTopic_js[27];
  char_T b_zeroDelimTopic_h[27];
  boolean_T icf_c[26];
  boolean_T icf_n[26];
  char_T b_zeroDelimTopic_k[26];
  char_T b_zeroDelimTopic_av[26];
  char_T b_zeroDelimTopic_fn[25];
  char_T b_zeroDelimTopic_jz[25];
  char_T b_zeroDelimTopic_kl[25];
  ...
  boolean_T corr[20];
  char_T b_zeroDelimTopic_fnt[20];
  char_T b_zeroDelimTopic_iv[19];
  ...
  sJ4ih70VmKcvCeguWN0mNVF deadline_cq;
  sJ4ih70VmKcvCeguWN0mNVF deadline_e;
  SL_Bus_sonia_common_ros2_MotorPwm BusAssignment_p_m;/* '<S2>/Bus Assignment' */
  ...
  real_T Probe_o4[2];                  /* '<S160>/Probe' */
  real_T Delay[8];                     /* '<S160>/Delay' */
  ...
  real_T Sum_ks_j;                     /* '<S230>/Sum' */
  real_T Product1_g_g;                 /* '<S194>/Product1' */
  real_T Product3_ly_o;                /* '<S243>/Product3' */
  real_T Product8_bq_h;                /* '<S197>/Product8' */
  ...
  real_T out1_tmp_tmp_lc;
  real_T out1_tmp_tmp_pr;
  real_T out1_tmp_br;
  real_T out1_tmp_fy;
  real_T out1_tmp_is;
  real_T out1_tmp_ci;
  ...
  real_T ct_tmp_tmp_p;
  real_T ct_tmp_tmp_l;
  real_T ct_tmp_tmp_l1;
  real_T ct_tmp_tmp_i5;
  real_T ct_tmp_okp;
  real_T ct_tmp_bv;
  real_T ct_tmp_it;
  real_T ct_tmp_gv;
  ...
  int32_T assign_temp_d_size_o[2];
  int32_T tmp_size_gy[2];
  int32_T tmp_size_pd[2];
  ...
  int32_T i_if;
  int32_T i21;
  int32_T obj_next_next_next_next_next__n;
  int32_T i22;
  int32_T i_ev;
  int32_T i_gz;
  int32_T b_i_j;
  ...
  int32_T aux_0_1_i;
  int32_T aux_1_1_g;
  int32_T stride_0_0_i1;
  int32_T stride_1_0_i;
  int32_T stride_0_1_ph;
  ...
  int32_T tmp_size_d[1];
  int32_T tmp_size_o[1];
  int32_T Je_size[1];
  int32_T z_size[1];
  int32_T tau_size[1];
  int32_T tmp_size_dg[1];
  ...
  B_EnabledSubsystem_proc_con_e_T EnabledSubsystem_h;/* '<S302>/Enabled Subsystem' */
...
struct DW_proc_control_lite_T {
  ...
  ros_slros2_internal_block_Sub_T obj_ln;/* '<S302>/SourceBlock' */
  ...
  real_T init_o;                       /* '<S48>/MATLAB System' */
  ...
  struct {
    void *LoggedData;
  } orientation_PWORK;                 /* '<S169>/orientation' */

  struct {
    void *LoggedData;
  } Scope_PWORK;                       /* '<S161>/Scope' */

  struct {
    void *LoggedData;
  } Scope1_PWORK_g;                    /* '<S161>/Scope1' */

  struct {
    void *LoggedData;
  } Scope2_PWORK;                      /* '<S161>/Scope2' */

  struct {
    void *LoggedData;
  } Scope3_PWORK;                      /* '<S161>/Scope3' */

  struct {
    void *LoggedData;
  } Scope_PWORK_e;                     /* '<S248>/Scope' */

  struct {
    void *LoggedData;
  } Scope_PWORK_b;                     /* '<S250>/Scope' */

  struct {
    void *LoggedData;
  } Scope_PWORK_p;                     /* '<S158>/Scope' */

  struct {
    void *LoggedData;
  } Scope_PWORK_g;                     /* '<S156>/Scope' */
  ...
  matlabshared_tracking_interna_T obj_lm;/* '<S237>/MATLAB System' */
  matlabshared_tracking_interna_T obj_ph;/* '<S236>/MATLAB System' */
  matlabshared_tracking_interna_T obj_pc;/* '<S235>/MATLAB System' */
  matlabshared_tracking_inter_h_T obj_jqd;/* '<S239>/MATLAB System' */
  uint16_T Delay_DSTATE_m[8];          /* '<S4>/Delay' */
  boolean_T Delay_DSTATE_g;            /* '<S250>/Delay' */
  ...
  boolean_T init_k;                    /* '<S50>/MATLAB System' */
  ...
  boolean_T objisempty_en;             /* '<S239>/MATLAB System' */
  boolean_T objisempty_bs;             /* '<S237>/MATLAB System' */
  boolean_T objisempty_jr;             /* '<S236>/MATLAB System' */
  boolean_T objisempty_ni;             /* '<S235>/MATLAB System' */
  ...
  boolean_T Memory_PreviousInput_l[226];/* '<S58>/Memory' */
  ...
  boolean_T objisempty_on;             /* '<S35>/SourceBlock' */
...
struct P_proc_control_lite_T_ {
  ...
  P_EnabledSubsystem_proc_con_p_T EnabledSubsystem_h;/* '<S302>/Enabled Subsystem' */
...
class proc_control_lite final
{
 ...
 private:
  ...
  /* private member function(s) for subsystem '<S303>/Enabled Subsystem'*/
  ...
  /* private member function(s) for subsystem '<S304>/Enabled Subsystem'*/
 ...
 * '<S233>' : 'proc_control_lite/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter'
 * '<S234>' : 'proc_control_lite/Subsystem ProcNav/Enabled Subsystem/Subsystem'
 * '<S235>' : 'proc_control_lite/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Correct1'
 * '<S236>' : 'proc_control_lite/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Correct2'
 * '<S237>' : 'proc_control_lite/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Correct3'
 * '<S238>' : 'proc_control_lite/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Output'
 * '<S239>' : 'proc_control_lite/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Predict'
 * '<S240>' : 'proc_control_lite/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Output/MATLAB Function'
 ...
 * '<S299>' : 'proc_control_lite/proc_nav_ros_input_lite1/Enabled Subsystem1/MinMax Running Resettable3/Subsystem'
 * '<S300>' : 'proc_control_lite/proc_nav_ros_input_lite1/Simulation/Blank Message'
 * '<S301>' : 'proc_control_lite/proc_nav_ros_input_lite1/Simulation/Publish'
 * '<S302>' : 'proc_control_lite/proc_nav_ros_input_lite1/Simulation/proc_simulation depth'
 * '<S303>' : 'proc_control_lite/proc_nav_ros_input_lite1/Simulation/proc_simulation dvl_velocity'
 * '<S304>' : 'proc_control_lite/proc_nav_ros_input_lite1/Simulation/proc_simulation imu_info'
 * '<S305>' : 'proc_control_lite/proc_nav_ros_input_lite1/Simulation/provider_imu imu_info1'
 * '<S306>' : 'proc_control_lite/proc_nav_ros_input_lite1/Simulation/proc_simulation depth/Enabled Subsystem'
 * '<S307>' : 'proc_control_lite/proc_nav_ros_input_lite1/Simulation/proc_simulation dvl_velocity/Enabled Subsystem'
 * '<S308>' : 'proc_control_lite/proc_nav_ros_input_lite1/Simulation/proc_simulation imu_info/Enabled Subsystem'
 * '<S309>' : 'proc_control_lite/proc_nav_ros_input_lite1/Simulation/provider_imu imu_info1/Enabled Subsystem'
 */
