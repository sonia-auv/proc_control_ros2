...
class proc_control final
{
 ...
 public:
  ...
  struct B_proc_control_T {
    ...
    SL_Bus_geometry_msgs_Pose rtb_SourceBlock_o2_m_d;
    SL_Bus_geometry_msgs_Pose BusAssignment_c;// '<S83>/Bus Assignment'
    SL_Bus_geometry_msgs_Pose BusAssignment_e;
    ...
    quaternion_proc_control_T expl_temp_cf;
    ...
    real_T umvk_k;
    real_T wtYerr_p;
    real_T obj_next_next_next_next_next__p;
    real_T sina;
    real_T sinb;
    real_T sinc;
    real_T cosa;
    ...
    real_T out1_tmp_tmp_mi;
    real_T out1_tmp_tmp_h5;
    real_T out1_tmp_awu;
    real_T out1_tmp_oqc;
    real_T out1_tmp_io;
    real_T out1_tmp_es;
    ...
    real_T ct_tmp_co;
    real_T ct_tmp_fof;
    real_T ct_tmp_tmp_bn;
    real_T ct_tmp_tmp_de;
    real_T ct_tmp_tmp_j;
    real_T ct_tmp_tmp_oe;
    real_T ct_tmp_tmp_l;
    real_T ct_tmp_gj;
    real_T ct_tmp_m;
    real_T ct_tmp_gh;
    ...
    real_T ct_tmp_eq1;
    real_T ct_tmp_cgj;
    real_T ct_tmp_tmp_hy;
    real_T ct_tmp_tmp_o4;
    real_T ct_tmp_dz;
    real_T ct_tmp_dfv;
    real_T ct_tmp_j4;
    real_T ct_tmp_f2k;
    ...
    real_T c_fw;
    real_T obj_maxConstrWorkspace_g;
    real_T c_n;
    real_T sina_e;
    real_T sinb_d;
    real_T dotSY;
    ...
    int32_T tmp_size_b2[1];
    int32_T tmp_size_lz[1];
    int32_T tmp_size_br[1];
    int32_T Je_size[1];
    int32_T z_size[1];
    int32_T tau_size[1];
    int32_T tmp_size_na[1];
