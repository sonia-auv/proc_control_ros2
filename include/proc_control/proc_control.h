...
class proc_control final
{
 ...
 public:
  ...
  struct B_proc_control_T {
    ...
    SL_Bus_trajectory_msgs_MultiDOFJointTrajectoryPoint In1;// '<S345>/In1'
    ...
    real_T DataTypeConversion_uState[95];// '<S317>/DataTypeConversion_uState'
    ...
    real_T b_xoff[21];
    real_T rtb_X_e_d[21];
    real_T Transpose_bj[18];           // '<S347>/Transpose'
    real_T Opt[18];
    real_T Rhs[18];
    boolean_T bv1[130];
    boolean_T bv2[130];
    ...
    real_T twpt[9];
    real_T TmpSignalConversionAtMATL_d[9];// '<S335>/Enabled Subsystem'
    real_T zopt[9];
    ...
    SL_Bus_geometry_msgs_Twist In1_l;  // '<S343>/In1'
    ...
    SL_Bus_geometry_msgs_Vector3 BusAssignment_n;// '<S261>/Bus Assignment'
    real_T Gain[3];                    // '<S333>/Gain'
    real_T b_n[3];
    real_T qu[3];
    real_T Sum_h[3];                   // '<S248>/Sum'
    real_T Sum5[3];                    // '<S29>/Sum5'
    real_T corr_lin_accel[3];          // '<S248>/MATLAB Function3'
    ...
    char_T b_zeroDelimTopic_kuk[21];
    boolean_T corr[20];
    char_T b_zeroDelimTopic_jk[20];
    char_T b_zeroDelimTopic_hc[19];
    ...
    char_T b_zeroDelimTopic_hm4[16];
    ...
    real_T MatrixConcatenate[2];       // '<S347>/Matrix Concatenate'
    real_T Selector[6];                // '<S347>/Selector'
    real_T Selector1[8];               // '<S347>/Selector1'
    real_T Selector4[7];               // '<S347>/Selector4'
    real_T DataTypeConversion[6];      // '<S346>/Data Type Conversion'
    real_T DataTypeConversion1[2];     // '<S346>/Data Type Conversion1'
    real_T dv24[2];
    real_T dv25[2];
    real_T dv26[2];
    real_T obj[2];
    ...
    real_T DataTypeConversion2;        // '<S346>/Data Type Conversion2'
    ...
    real_T rtb_AngularRateZed_idx_2;
    real_T rtb_AngularRateZed_idx_1;
    real_T rtb_AngularRateZed_idx_0;
    real_T WorldPosition_idx_0;
    real_T y_i_idx_3;
    real_T rtb_sincos_o2_idx_1;
    real_T rtb_sincos_o2_idx_0;
    real_T e_o;
    real_T rtb_Sum_tmp;
    real_T rtb_Sum_tmp_f;
    real_T rtb_Sum_l_tmp;
    real_T rtb_Product1_n_tmp;
    real_T rtb_Sum_tmp_m;
    real_T d_tmp;
    real_T t25_tmp;
    real_T t37_tmp;
    real_T t27_tmp;
    ...
    real_T t86_tmp_tmp_g;
    real_T t88_tmp_tmp_m;
    real_T t99_tmp_tmp_o;
    real_T t100_tmp_tmp_f;
    real_T t95_tmp_tmp_i;
    real_T t96_tmp_tmp_d;
    real_T t114_tmp_tmp_f;
    real_T t111_tmp_tmp_nq;
    real_T t118_tmp_tmp_d;
    real_T in4_tmp_cj;
    real_T in4_tmp_bf;
    real_T in4_tmp_bm;
    real_T t122_tmp_tmp_h;
    real_T in4_tmp_gj;
    real_T in4_tmp_cp;
    real_T in4_tmp_dw;
    real_T in4_tmp_a1;
    ...
    real_T ct_tmp_ej;
    real_T ct_tmp_ob;
    real_T ct_tmp_tmp_jx;
    real_T ct_tmp_tmp_f;
    real_T ct_tmp_tmp_kl;
    real_T ct_tmp_tmp_ny;
    real_T ct_tmp_f3r;
    real_T ct_tmp_pfi;
    real_T ct_tmp_i1q;
    real_T ct_tmp_kbu;
    ...
    real_T c_cz;
    real_T obj_maxConstrWorkspace_a;
    real_T c_j;
    real_T sina_a;
    real_T sinb_l;
    real_T sinc_b;
    ...
    int32_T tmp_size_h0[2];
    int32_T tmp_size_kq[2];
    int32_T tmp_size_i2[2];
    int32_T tmp_size_kl[2];
    int32_T tmp_size_j2[2];
    int32_T assign_temp_a_size_k[2];
    int32_T assign_temp_b_size_e[2];
    int32_T tmp_size_b5[2];
    ...
    int32_T tmp_size_pl[1];
    int32_T Je_size[1];
    int32_T z_size[1];
    int32_T tau_size[1];
    int32_T tmp_size_o[1];
    int8_T MpcStatus;                  // '<S140>/Merge'
    boolean_T SourceBlock_o1;          // '<S344>/SourceBlock'
    boolean_T MATLABSystem_o3_k;       // '<S319>/MATLAB System'
  ...
  struct DW_proc_control_T {
    TrajectoryManager_proc_contro_T obj;// '<S335>/MATLAB System1'
    ProcPlannerManager_proc_contr_T obj_l;// '<S330>/MATLAB System'
    mpcManager_proc_control_T obj_k;   // '<S141>/MATLAB System'
    TrimPlant_proc_control_T obj_b;    // '<S143>/MATLAB System'
    robotics_slcore_internal_bl_p_T obj_m;// '<S351>/Polynomial Trajectory'
    AuvDifferentialEquation_proc__T obj_f;// '<S3>/MATLAB System'
    OpenLoopController_proc_contr_T obj_p;// '<S145>/MATLAB System'
    robotics_slcore_internal_bloc_T obj_p3;// '<S348>/Rotation Trajectory'
    AddPose_proc_control_T obj_fo;     // '<S335>/MATLAB System'
    ...
    ros_slros2_internal_block_Pub_T obj_oe;// '<S340>/SinkBlock'
    ros_slros2_internal_block_Pub_T obj_g4;// '<S271>/SinkBlock'
    ros_slros2_internal_block_Pub_T obj_nn;// '<S269>/SinkBlock'
    ...
    ros_slros2_internal_block_Sub_T obj_ha;// '<S349>/SourceBlock'
    ros_slros2_internal_block_Sub_T obj_eh;// '<S344>/SourceBlock'
    ros_slros2_internal_block_Sub_T obj_jb;// '<S342>/SourceBlock'
    ...
    real_T DiscreteTimeIntegrator_DSTATE_a;// '<S348>/Discrete-Time Integrator'
    real_T UD_DSTATE;                  // '<S309>/UD'
    ...
    real_T P[169];                     // '<S317>/DataStoreMemory - P'
    real_T x[13];                      // '<S317>/DataStoreMemory - x'
    ...
    boolean_T Delay_DSTATE_g;          // '<S335>/Delay'
    boolean_T DelayInput1_DSTATE;      // '<S337>/Delay Input1'
  ...
  struct PrevZCX_proc_control_T {
    ZCSigState ResettableSubsystem_Reset_ZCE;// '<S335>/Resettable Subsystem'
  };
  ...
  struct P_proc_control_T {
    ...
    SL_Bus_geometry_msgs_Vector3 Constant_Value_gb;// Computed Parameter: Constant_Value_gb
    ...
    real_T MATLABSystem1_linearConvergence;// Expression: .25
                                              //  Referenced by: '<S335>/MATLAB System1'
    ...
    real_T PolynomialTrajectory_VelocityBo[6];// Expression: zeros( 3, 2 )
                                                 //  Referenced by: '<S351>/Polynomial Trajectory'
    ...
    real_T Constant_Value_gbn;         // Expression: 0.5
    ...
    real_T VNIMUPOS_Value[3];          // Expression: [-0.00277 0 0.06591]
    ...
    real_T PosZEDIMU_Value[3];         // Expression: [0.39591 0.0 0.0]
...
//  Block '<S290>/sqrt' : Unused code path elimination
...
//  Block '<S288>/Gain1' : Unused code path elimination
//  Block '<S288>/Gain2' : Unused code path elimination
...
//  Block '<S288>/Product4' : Unused code path elimination
//  Block '<S288>/Product5' : Unused code path elimination
//  Block '<S288>/Product6' : Unused code path elimination
//  Block '<S288>/Product7' : Unused code path elimination
//  Block '<S288>/Product8' : Unused code path elimination
//  Block '<S288>/Sum' : Unused code path elimination
//  Block '<S288>/Sum1' : Unused code path elimination
//  Block '<S288>/Sum2' : Unused code path elimination
//  Block '<S288>/Sum3' : Unused code path elimination
...
//  Block '<S302>/1//2' : Unused code path elimination
//  Block '<S302>/q0' : Unused code path elimination
//  Block '<S302>/q1' : Unused code path elimination
//  Block '<S302>/q2' : Unused code path elimination
//  Block '<S302>/q3' : Unused code path elimination
//  Block '<S302>/sincos' : Unused code path elimination
...
//  Block '<S313>/Gain1' : Unused code path elimination
//  Block '<S313>/Gain2' : Unused code path elimination
...
//  Block '<S313>/Product4' : Unused code path elimination
//  Block '<S313>/Product5' : Unused code path elimination
//  Block '<S313>/Product6' : Unused code path elimination
//  Block '<S313>/Product7' : Unused code path elimination
//  Block '<S313>/Product8' : Unused code path elimination
//  Block '<S313>/Sum' : Unused code path elimination
//  Block '<S313>/Sum1' : Unused code path elimination
//  Block '<S313>/Sum2' : Unused code path elimination
//  Block '<S313>/Sum3' : Unused code path elimination
...
//  Block '<S317>/checkMeasurementFcn1Signals' : Unused code path elimination
//  Block '<S317>/checkMeasurementFcn2Signals' : Unused code path elimination
//  Block '<S317>/checkMeasurementFcn3Signals' : Unused code path elimination
//  Block '<S317>/checkStateTransitionFcnSignals' : Unused code path elimination
...
//  Block '<S318>/Zero-Order Hold' : Unused code path elimination
...
//  Block '<S329>/Matrix Concatenate' : Unused code path elimination
//  Block '<S329>/Scope' : Unused code path elimination
//  Block '<S329>/Scope1' : Unused code path elimination
//  Block '<S329>/Scope2' : Unused code path elimination
//  Block '<S329>/Scope3' : Unused code path elimination
//  Block '<S329>/Selector' : Unused code path elimination
//  Block '<S329>/Selector1' : Unused code path elimination
//  Block '<S329>/Selector2' : Unused code path elimination
//  Block '<S329>/Selector3' : Unused code path elimination
//  Block '<S329>/Selector4' : Unused code path elimination
//  Block '<S329>/Sum' : Unused code path elimination
//  Block '<S329>/e angular rates' : Unused code path elimination
//  Block '<S329>/e position' : Unused code path elimination
//  Block '<S329>/e quaternion' : Unused code path elimination
//  Block '<S329>/e velocity' : Unused code path elimination
//  Block '<S333>/Scope' : Unused code path elimination
//  Block '<S347>/Display' : Unused code path elimination
//  Block '<S347>/Selector3' : Unused code path elimination
//  Block '<S335>/Scope' : Unused code path elimination
//  Block '<S350>/Constant1' : Unused code path elimination
//  Block '<S350>/Constant2' : Unused code path elimination
//  Block '<S350>/Constant3' : Unused code path elimination
//  Block '<S350>/Constant4' : Unused code path elimination
//  Block '<S350>/Constant5' : Unused code path elimination
//  Block '<S350>/Constant6' : Unused code path elimination
//  Block '<S350>/Frame' : Unused code path elimination
//  Block '<S350>/fine' : Unused code path elimination
//  Block '<S350>/speed' : Unused code path elimination
//  Block '<S350>/speed1' : Unused code path elimination
...
//  Block '<S317>/DataTypeConversion_Enable1' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_Enable2' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_Enable3' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_Q' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_R1' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_R2' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_R3' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_uMeas1' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_uMeas2' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_uMeas3' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_y1' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_y2' : Eliminate redundant data type conversion
//  Block '<S317>/DataTypeConversion_y3' : Eliminate redundant data type conversion
...
//  '<S261>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Publish IMU Vel1'
...
//  '<S266>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation2'
//  '<S267>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation3'
//  '<S268>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Publish IMU Vel/Blank Message'
//  '<S269>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Publish IMU Vel/Publish'
//  '<S270>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Publish IMU Vel1/Blank Message'
//  '<S271>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Publish IMU Vel1/Publish'
//  '<S272>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Inverse/Quaternion Conjugate'
//  '<S273>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Inverse/Quaternion Norm'
//  '<S274>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation/Quaternion Normalize'
//  '<S275>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation/V1'
//  '<S276>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation/V2'
//  '<S277>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation/V3'
//  '<S278>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation/Quaternion Normalize/Quaternion Modulus'
//  '<S279>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation/Quaternion Normalize/Quaternion Modulus/Quaternion Norm'
//  '<S280>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation1/Quaternion Normalize'
//  '<S281>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation1/V1'
//  '<S282>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation1/V2'
//  '<S283>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation1/V3'
//  '<S284>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation1/Quaternion Normalize/Quaternion Modulus'
//  '<S285>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation1/Quaternion Normalize/Quaternion Modulus/Quaternion Norm'
//  '<S286>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation2/Quaternion Normalize'
//  '<S287>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation2/V1'
//  '<S288>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation2/V2'
//  '<S289>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation2/V3'
//  '<S290>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation2/Quaternion Normalize/Quaternion Modulus'
//  '<S291>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation2/Quaternion Normalize/Quaternion Modulus/Quaternion Norm'
//  '<S292>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation3/Quaternion Normalize'
//  '<S293>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation3/V1'
//  '<S294>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation3/V2'
//  '<S295>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation3/V3'
//  '<S296>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation3/Quaternion Normalize/Quaternion Modulus'
//  '<S297>' : 'proc_control/Subsystem ProcNav/AHRS//Detph Mesurments/Quaternion Rotation3/Quaternion Normalize/Quaternion Modulus/Quaternion Norm'
//  '<S298>' : 'proc_control/Subsystem ProcNav/DVL Measurements/DVL2Ship'
//  '<S299>' : 'proc_control/Subsystem ProcNav/DVL Measurements/MATLAB Function'
//  '<S300>' : 'proc_control/Subsystem ProcNav/DVL Measurements/Quaternion Rotation'
//  '<S301>' : 'proc_control/Subsystem ProcNav/DVL Measurements/DVL2Ship/Enabled Subsystem'
//  '<S302>' : 'proc_control/Subsystem ProcNav/DVL Measurements/DVL2Ship/Enabled Subsystem/Rotation Angles to Quaternions'
//  '<S303>' : 'proc_control/Subsystem ProcNav/DVL Measurements/Quaternion Rotation/Quaternion Normalize'
//  '<S304>' : 'proc_control/Subsystem ProcNav/DVL Measurements/Quaternion Rotation/V1'
//  '<S305>' : 'proc_control/Subsystem ProcNav/DVL Measurements/Quaternion Rotation/V2'
//  '<S306>' : 'proc_control/Subsystem ProcNav/DVL Measurements/Quaternion Rotation/V3'
//  '<S307>' : 'proc_control/Subsystem ProcNav/DVL Measurements/Quaternion Rotation/Quaternion Normalize/Quaternion Modulus'
//  '<S308>' : 'proc_control/Subsystem ProcNav/DVL Measurements/Quaternion Rotation/Quaternion Normalize/Quaternion Modulus/Quaternion Norm'
//  '<S309>' : 'proc_control/Subsystem ProcNav/Depth Measurements/Discrete Derivative'
//  '<S310>' : 'proc_control/Subsystem ProcNav/Depth Measurements/Quaternion Rotation'
//  '<S311>' : 'proc_control/Subsystem ProcNav/Depth Measurements/Quaternion Rotation/Quaternion Normalize'
//  '<S312>' : 'proc_control/Subsystem ProcNav/Depth Measurements/Quaternion Rotation/V1'
//  '<S313>' : 'proc_control/Subsystem ProcNav/Depth Measurements/Quaternion Rotation/V2'
//  '<S314>' : 'proc_control/Subsystem ProcNav/Depth Measurements/Quaternion Rotation/V3'
//  '<S315>' : 'proc_control/Subsystem ProcNav/Depth Measurements/Quaternion Rotation/Quaternion Normalize/Quaternion Modulus'
//  '<S316>' : 'proc_control/Subsystem ProcNav/Depth Measurements/Quaternion Rotation/Quaternion Normalize/Quaternion Modulus/Quaternion Norm'
//  '<S317>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter'
//  '<S318>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Subsystem'
//  '<S319>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Correct1'
//  '<S320>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Correct2'
//  '<S321>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Correct3'
//  '<S322>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Output'
//  '<S323>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Predict'
//  '<S324>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Output/MATLAB Function'
//  '<S325>' : 'proc_control/Subsystem ProcNav/mux2Bus/Quaternion Inverse'
//  '<S326>' : 'proc_control/Subsystem ProcNav/mux2Bus/Quaternion Inverse/Quaternion Conjugate'
//  '<S327>' : 'proc_control/Subsystem ProcNav/mux2Bus/Quaternion Inverse/Quaternion Norm'
//  '<S328>' : 'proc_control/Subsystem Trajectory/IDLE'
//  '<S329>' : 'proc_control/Subsystem Trajectory/Performance Graph'
//  '<S330>' : 'proc_control/Subsystem Trajectory/ProcPlanner Trajectory'
//  '<S331>' : 'proc_control/Subsystem Trajectory/Send Current Target'
//  '<S332>' : 'proc_control/Subsystem Trajectory/SpaceNav'
//  '<S333>' : 'proc_control/Subsystem Trajectory/Subsystem'
//  '<S334>' : 'proc_control/Subsystem Trajectory/Subsystem1'
//  '<S335>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only'
//  '<S336>' : 'proc_control/Subsystem Trajectory/IDLE/MATLAB Function'
//  '<S337>' : 'proc_control/Subsystem Trajectory/ProcPlanner Trajectory/Detect Rise Positive'
//  '<S338>' : 'proc_control/Subsystem Trajectory/ProcPlanner Trajectory/Detect Rise Positive/Positive'
//  '<S339>' : 'proc_control/Subsystem Trajectory/Send Current Target/Blank Message'
//  '<S340>' : 'proc_control/Subsystem Trajectory/Send Current Target/Publish'
//  '<S341>' : 'proc_control/Subsystem Trajectory/SpaceNav/MATLAB Function'
//  '<S342>' : 'proc_control/Subsystem Trajectory/Subsystem/Subscribe'
//  '<S343>' : 'proc_control/Subsystem Trajectory/Subsystem/Subscribe/Enabled Subsystem'
//  '<S344>' : 'proc_control/Subsystem Trajectory/Subsystem1/Subscribe'
//  '<S345>' : 'proc_control/Subsystem Trajectory/Subsystem1/Subscribe/Enabled Subsystem'
//  '<S346>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Enabled Subsystem'
//  '<S347>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Pre-traitement'
//  '<S348>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Resettable Subsystem'
//  '<S349>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Subscribe'
//  '<S350>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Subsystem'
//  '<S351>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Resettable Subsystem/Subsystem'
//  '<S352>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Subscribe/Enabled Subsystem'
