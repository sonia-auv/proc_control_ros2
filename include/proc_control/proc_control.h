...
// C/C++ source code generated on : Wed Nov 26 23:40:08 2025
//
...
class proc_control final
{
 ...
 public:
  ...
  struct B_proc_control_T {
    ...
    SL_Bus_trajectory_msgs_MultiDOFJointTrajectoryPoint In1;// '<S331>/In1'
    ...
    real_T b_xoff[21];
    real_T rtb_X_e_j[21];
    real_T Transpose_bj[18];           // '<S333>/Transpose'
    real_T Opt[18];
    real_T Rhs[18];
    boolean_T bv1[130];
    boolean_T bv2[130];
    ...
    real_T twpt[9];
    real_T TmpSignalConversionAtMATL_d[9];// '<S321>/Enabled Subsystem'
    real_T t[9];
    real_T zopt[9];
    ...
    SL_Bus_geometry_msgs_Twist In1_l;  // '<S329>/In1'
    ...
    real_T rtb_corr_lin_accel_l[5];
    real_T rtb_corr_lin_accel_g[5];
    real_T b_tau_d4[5];
    real_T work_dv[5];
    ...
    char_T b_zeroDelimTopic_kl[30];
    char_T b_zeroDelimTopic_b[30];
    char_T b_zeroDelimTopic_hm[30];
    ...
    real_T Gain[3];                    // '<S319>/Gain'
    real_T MatrixConcatenate[2];       // '<S333>/Matrix Concatenate'
    real_T Selector[6];                // '<S333>/Selector'
    real_T Selector1[8];               // '<S333>/Selector1'
    real_T Selector4[7];               // '<S333>/Selector4'
    real_T DataTypeConversion[6];      // '<S332>/Data Type Conversion'
    real_T DataTypeConversion1[2];     // '<S332>/Data Type Conversion1'
    real_T DataTypeConversion2;        // '<S332>/Data Type Conversion2'
    ...
    real_T Divide1;                    // '<S263>/Divide1'
    real_T Divide3;                    // '<S263>/Divide3'
    real_T Divide2_j;                  // '<S51>/Divide2'
    real_T Divide1_e;                  // '<S51>/Divide1'
    real_T Output_o;                   // '<S44>/Output'
    real_T Product1_nv;                // '<S74>/Product1'
    real_T n_j;
    real_T rtb_Multiply1_idx_2;
    real_T rtb_Multiply1_idx_1;
    real_T rtb_Multiply1_idx_0;
    real_T y_i_idx_3;
    real_T y_i_idx_2;
    real_T y_i_idx_1;
    ...
    real_T ct_tmp_bn;
    real_T ct_tmp_de;
    real_T ct_tmp_tmp_jm;
    real_T ct_tmp_tmp_o;
    real_T ct_tmp_tmp_li;
    real_T ct_tmp_tmp_gj;
    real_T ct_tmp_tmp_m;
    real_T ct_tmp_gh;
    real_T ct_tmp_an;
    real_T ct_tmp_eya;
    ...
    int32_T activeSetChangeID_o;
    int32_T nVar_p40;
    int32_T globalActiveConstrIdx_p;
    int32_T idxMinLambda_g;
    int32_T k_gq;
    int32_T iQR0_e;
    int32_T g_j;
    int32_T nVar_n;
    ...
    int32_T tmp_size_bs[1];
    int32_T tmp_size_ch[1];
    ...
    boolean_T SourceBlock_o1;          // '<S330>/SourceBlock'
    boolean_T MATLABSystem_o3_k;       // '<S305>/MATLAB System'
  ...
  struct DW_proc_control_T {
    TrajectoryManager_proc_contro_T obj;// '<S321>/MATLAB System1'
    ProcPlannerManager_proc_contr_T obj_l;// '<S316>/MATLAB System'
    mpcManager_proc_control_T obj_k;   // '<S143>/MATLAB System'
    TrimPlant_proc_control_T obj_b;    // '<S145>/MATLAB System'
    robotics_slcore_internal_bl_p_T obj_m;// '<S337>/Polynomial Trajectory'
    AuvDifferentialEquation_proc__T obj_f;// '<S3>/MATLAB System'
    OpenLoopController_proc_contr_T obj_p;// '<S147>/MATLAB System'
    robotics_slcore_internal_bloc_T obj_p3;// '<S334>/Rotation Trajectory'
    AddPose_proc_control_T obj_fo;     // '<S321>/MATLAB System'
    ...
    ros_slros2_internal_block_Pub_T obj_oe;// '<S326>/SinkBlock'
    ...
    ros_slros2_internal_block_Sub_T obj_ha;// '<S335>/SourceBlock'
    ros_slros2_internal_block_Sub_T obj_eh;// '<S330>/SourceBlock'
    ros_slros2_internal_block_Sub_T obj_jb;// '<S328>/SourceBlock'
    ...
    real_T DiscreteTimeIntegrator_DSTATE_a;// '<S334>/Discrete-Time Integrator'
    ...
    boolean_T Delay_DSTATE_g;          // '<S321>/Delay'
    boolean_T DelayInput1_DSTATE;      // '<S323>/Delay Input1'
  ...
  struct PrevZCX_proc_control_T {
    ZCSigState ResettableSubsystem_Reset_ZCE;// '<S321>/Resettable Subsystem'
  };
  ...
  struct P_proc_control_T {
    ...
    real_T MATLABSystem1_linearConvergence;// Expression: .25
                                              //  Referenced by: '<S321>/MATLAB System1'
    ...
    real_T PolynomialTrajectory_VelocityBo[6];// Expression: zeros( 3, 2 )
                                                 //  Referenced by: '<S337>/Polynomial Trajectory'
    ...
    boolean_T yBlockOrdering_Y0;       // Computed Parameter: yBlockOrdering_Y0
                                          //  Referenced by: '<S305>/yBlockOrdering'
...
//  Block '<S289>/1//2' : Unused code path elimination
//  Block '<S289>/q0' : Unused code path elimination
//  Block '<S289>/q1' : Unused code path elimination
//  Block '<S289>/q2' : Unused code path elimination
//  Block '<S289>/q3' : Unused code path elimination
//  Block '<S289>/sincos' : Unused code path elimination
...
//  Block '<S294>/sqrt' : Unused code path elimination
...
//  Block '<S315>/Matrix Concatenate' : Unused code path elimination
//  Block '<S315>/Scope' : Unused code path elimination
//  Block '<S315>/Scope1' : Unused code path elimination
//  Block '<S315>/Scope2' : Unused code path elimination
//  Block '<S315>/Scope3' : Unused code path elimination
//  Block '<S315>/Selector' : Unused code path elimination
//  Block '<S315>/Selector1' : Unused code path elimination
//  Block '<S315>/Selector2' : Unused code path elimination
//  Block '<S315>/Selector3' : Unused code path elimination
//  Block '<S315>/Selector4' : Unused code path elimination
//  Block '<S315>/Sum' : Unused code path elimination
//  Block '<S315>/e angular rates' : Unused code path elimination
//  Block '<S315>/e position' : Unused code path elimination
//  Block '<S315>/e quaternion' : Unused code path elimination
//  Block '<S315>/e velocity' : Unused code path elimination
//  Block '<S319>/Scope' : Unused code path elimination
//  Block '<S333>/Display' : Unused code path elimination
//  Block '<S333>/Selector3' : Unused code path elimination
//  Block '<S321>/Scope' : Unused code path elimination
//  Block '<S336>/Constant1' : Unused code path elimination
//  Block '<S336>/Constant2' : Unused code path elimination
//  Block '<S336>/Constant3' : Unused code path elimination
//  Block '<S336>/Constant4' : Unused code path elimination
//  Block '<S336>/Constant5' : Unused code path elimination
//  Block '<S336>/Constant6' : Unused code path elimination
//  Block '<S336>/Frame' : Unused code path elimination
//  Block '<S336>/fine' : Unused code path elimination
//  Block '<S336>/speed' : Unused code path elimination
//  Block '<S336>/speed1' : Unused code path elimination
...
//  '<S305>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Correct1'
//  '<S306>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Correct2'
//  '<S307>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Correct3'
//  '<S308>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Output'
//  '<S309>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Predict'
//  '<S310>' : 'proc_control/Subsystem ProcNav/Enabled Subsystem/Extended Kalman Filter/Output/MATLAB Function'
//  '<S311>' : 'proc_control/Subsystem ProcNav/mux2Bus/Quaternion Inverse'
//  '<S312>' : 'proc_control/Subsystem ProcNav/mux2Bus/Quaternion Inverse/Quaternion Conjugate'
//  '<S313>' : 'proc_control/Subsystem ProcNav/mux2Bus/Quaternion Inverse/Quaternion Norm'
//  '<S314>' : 'proc_control/Subsystem Trajectory/IDLE'
//  '<S315>' : 'proc_control/Subsystem Trajectory/Performance Graph'
//  '<S316>' : 'proc_control/Subsystem Trajectory/ProcPlanner Trajectory'
//  '<S317>' : 'proc_control/Subsystem Trajectory/Send Current Target'
//  '<S318>' : 'proc_control/Subsystem Trajectory/SpaceNav'
//  '<S319>' : 'proc_control/Subsystem Trajectory/Subsystem'
//  '<S320>' : 'proc_control/Subsystem Trajectory/Subsystem1'
//  '<S321>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only'
//  '<S322>' : 'proc_control/Subsystem Trajectory/IDLE/MATLAB Function'
//  '<S323>' : 'proc_control/Subsystem Trajectory/ProcPlanner Trajectory/Detect Rise Positive'
//  '<S324>' : 'proc_control/Subsystem Trajectory/ProcPlanner Trajectory/Detect Rise Positive/Positive'
//  '<S325>' : 'proc_control/Subsystem Trajectory/Send Current Target/Blank Message'
//  '<S326>' : 'proc_control/Subsystem Trajectory/Send Current Target/Publish'
//  '<S327>' : 'proc_control/Subsystem Trajectory/SpaceNav/MATLAB Function'
//  '<S328>' : 'proc_control/Subsystem Trajectory/Subsystem/Subscribe'
//  '<S329>' : 'proc_control/Subsystem Trajectory/Subsystem/Subscribe/Enabled Subsystem'
//  '<S330>' : 'proc_control/Subsystem Trajectory/Subsystem1/Subscribe'
//  '<S331>' : 'proc_control/Subsystem Trajectory/Subsystem1/Subscribe/Enabled Subsystem'
//  '<S332>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Enabled Subsystem'
//  '<S333>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Pre-traitement'
//  '<S334>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Resettable Subsystem'
//  '<S335>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Subscribe'
//  '<S336>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Subsystem'
//  '<S337>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Resettable Subsystem/Subsystem'
//  '<S338>' : 'proc_control/Subsystem Trajectory/singleWpts Trajectory Control DEBUG only/Subscribe/Enabled Subsystem'
