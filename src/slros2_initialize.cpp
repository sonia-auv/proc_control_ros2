...
SimulinkParameterArrayGetter<real64_T,std::vector<double>> ParamGet_proc_control_1797;
// For Block proc_control/Ros Command/Get_ROS_param/Subsystem/Get Parameter3
SimulinkParameterArrayGetter<real64_T,std::vector<double>> ParamGet_proc_control_1798;
